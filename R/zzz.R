...
.onLoad <- function(libname, pkgname) {
  ...
  op_supreme <- list(
    ...
    SUPREME_MODEL_OPTIONAL_FIELDS = c("input", "output", "return", "calling_modules", "src", "dependency"),
    SUPREME_MODEL_MULTI_VAR_FIELDS = c("input", "output", "return", "calling_modules", "dependency"),
